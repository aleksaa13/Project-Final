...
class Home extends React.Component {
  ...
  getFilterData=(dateString)=>{
    let godina=dateString.slice(0,4);
        ...
        moment.locale('sr');
        let mjesec=(moment().month(parseInt(mesec-1)).format('MMMM'));
        /* axios */
      ...
      <React.Fragment>
        <div className="container">
          <div class="ui secondary  menu">
            <a class="active item" onClick={this.handleHome}>Home</a>
        ...
        <div className="wrap">
          ...
          {this.state.filter === 'true' ? (
            <Filter items={this.state.filterItems} getFilterData={this.getFilterData}></Filter>
          ) : (
            <div>
